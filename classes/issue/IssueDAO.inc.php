...
class IssueDAO extends DAO implements PKPPubIdPluginDAO
{
     ...
     * @return GenericCache
     */
    public function _getCache($cacheId)
    {
     ...
     * @return Issue?
     */
    public function getById($issueId, $journalId = null, $useCache = false)
    {
        if ($useCache) {
     ...
     * @return Issue object
     */
    public function getByPubId($pubIdType, $pubId, $journalId = null, $useCache = false)
    {
     ...
     * @return Issue object
     */
    public function getByBestId($issueId, $contextId = null, $useCache = false)
    {
        $params = [$issueId];
        if ($contextId) {
     ...
     * @return Issue?
     */
    public function getCurrent($journalId, $useCache = false)
    {
        if ($useCache) {
     ...
     * @return Issue object
     */
    public function updateCurrent($journalId, $issue = null)
    {
        $this->update(
    ...
    public function _fromRow($row)
    {
        ...
        HookRegistry::call('IssueDAO::_fromRow', [&$issue, &$row]);
    ...
    public function _returnIssueFromRow($row)
    {
        ...
        HookRegistry::call('IssueDAO::_returnIssueFromRow', [&$issue, &$row]);
        return $issue;
    }
    ...
    {
        return ['title', 'description', 'coverImageAltText', 'coverImage'];
    }
     ...
     * @return Issue Id int
     */
    public function insertObject($issue)
    {
        $this->update(
            sprintf(
                'INSERT INTO issues
    ...
    public function issueExists($journalId, $volume, $number, $year, $issueId)
    {
        $result = $this->retrieve(
            ...
            [(int) $journalId, $this->nullOrInt($volume), $number, $year, (int) $issueId]
        );
     ...
     * @param Issue object
     */
    public function updateObject($issue)
    {
        $issue->stampModified();
        $this->update(
            sprintf(
     ...
     * @return Issue?
     */
    public function getBySubmissionId($articleId, $journalId = null)
    {
